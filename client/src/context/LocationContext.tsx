...
export const LocationProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    const savedCity = typeof window !== 'undefined' ? localStorage.getItem('cinebook_city') : null;
    if (savedCity) {
    ...
    const savedExtra = typeof window !== 'undefined' ? localStorage.getItem('cinebook_extra_cities') : null;
    if (savedExtra) {
