...
export default function BookingPage() {
  ...
  const toggleSeat = async (seat: any) => {
    ...
    // Single source of truth for "locked by someone else" — same logic as the
    // disabled prop in the seat map render below. The old isLocked/isLockedByMe
    // fields never existed on the server response, so that branch was dead code.
    const now = new Date();
    const isLockedByOther = seat.lockedBy &&
