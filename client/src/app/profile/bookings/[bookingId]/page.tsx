...
export default function TicketPage() {
  ...
  const showDate = booking.show?.date
    ? new Date(booking.show.date).toLocaleDateString('en-IN', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })
    : 'Completed Show';
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.ticket} ref={ticketRef}>
          ...
          <div className={styles.movieSection}>
            <h1 className={styles.movieTitle}>{booking.movie?.title || 'Movie'}</h1>
          ...
          <div className={styles.infoGrid}>
            ...
            <div className={styles.infoItem}>
              ...
              <div>
                ...
                <span className={styles.infoValue}>{booking.show?.time || 'Showtime'}</span>
              </div>
            </div>
            <div className={styles.infoItem}>
              ...
              <div>
                ...
                <span className={styles.infoValue}>{booking.show?.theater?.name || 'Cinema Hall'}</span>
                <span className={styles.infoSub}>{booking.show?.theater?.address || ''} {booking.show?.theater?.city ? `, ${booking.show.theater.city}` : ''}</span>
              </div>
            </div>
            <div className={styles.infoItem}>
              <span className={styles.infoIcon}>🪑</span>
