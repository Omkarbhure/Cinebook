...
// Rate limit QR verify endpoint — belt-and-suspenders on top of auth
...
// Verify route — requires admin auth. Lookup is by high-entropy verifyToken
// (embedded in QR), NOT by the human-readable bookingId, to prevent guessing.
router.get('/verify/:verifyToken', verifyLimiter, protect, adminOnly, verifyBooking);
